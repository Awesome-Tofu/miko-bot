...
- **Example Bot**: [Miko Bot](https://github.com/Awesome-Tofu/miko-bot/main/README.md#getting-started) I wont be running the bot from now on, but you can try the repo
